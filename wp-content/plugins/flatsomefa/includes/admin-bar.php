<?php
// Option links
function flatsome_admin_bar_helper_fa(){
...
$wp_admin_bar->add_menu( array(
 ...
 'title' => '<span class="dashicons dashicons-admin-generic" style="'.$icon_style.'"></span> تنظیمات قالب',
...
$wp_admin_bar->add_menu( array(
 'parent' => 'flatsome_panel',
 'id' => 'options_advanced',
 'title' => '<span class="dashicons dashicons-admin-tools" style="'.$icon_style.'"></span> پیشرفته',
 'href' =>  $advanced_url.''
));
...
if(!flatsome_is_theme_enabled()){
  $wp_admin_bar->add_menu( array(
   ...
   'title' => '<span class="dashicons dashicons-unlock" style="'.$icon_style.'"></span>فعال سازی قالب',
...
if(is_woocommerce_activated()) {
  ...
  $wp_admin_bar->add_menu( array(
   ...
   'href' =>  $optionUrl_panel.'woocommerce'
    ...
    $wp_admin_bar->add_menu( array(
     ...
     'title' => __( 'اطلاعیه سایت', 'woocommerce' ),
  ...
  $wp_admin_bar->add_menu( array(
   ...
   'title' => __( 'برگه کاتالوگ', 'woocommerce' ),
  ...
  $wp_admin_bar->add_menu( array(
   ...
   'href' =>  $optionUrl_section.'payment-icons'
    ...
    $wp_admin_bar->add_menu( array(
       ...
       'title' => __( 'تصاویر محصول', 'woocommerce' ),
...
$wp_admin_bar->add_menu( array(
 'parent' => 'theme_options',
 'id' => 'options_pages',
 'title' => '<span class="dashicons dashicons-admin-page" style="'.$icon_style.'"></span> برگه ها',
...
$wp_admin_bar->add_menu( array(
 'parent' => 'theme_options',
 'id' => 'options_blog',
 'title' => '<span class="dashicons dashicons-edit" style="'.$icon_style.'"></span> وبلاگ',
...
$wp_admin_bar->add_menu( array(
 ...
 'title' => '<span class="dashicons dashicons-portfolio" style="'.$icon_style.'"></span> نمونه کار',
...
$wp_admin_bar->add_menu( array(
 'parent' => 'theme_options',
 'id' => 'options_menus',
 'title' => '<span class="dashicons dashicons-menu " style="'.$icon_style.'"></span> منو ها',
...
$wp_admin_bar->add_menu( array(
 'parent' => 'theme_options',
 'id' => 'options_widgets',
 'title' => '<span class="dashicons dashicons-welcome-widgets-menus" style="'.$icon_style.'"></span> ویجت ها',
...
if(is_woocommerce_activated()) {
  ...
  if(is_product()){
         $wp_admin_bar->add_menu( array(
             'parent' => 'customize',
             'id' => 'admin_bar_helper',
             'title' => __('برگه محصول','woocommerce'),
 			 'href' =>  $optionUrl_section.'product-page'
         ));
  }
...
add_action( 'admin_bar_menu', 'flatsome_admin_bar_helper_fa' , 45);